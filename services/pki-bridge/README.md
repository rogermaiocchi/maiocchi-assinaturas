...
- Faixa lateral discreta nas páginas de conteúdo, sem divisor, com o `m.` centralizado e uma única inscrição: `DOCUMENTO <número> - HASH <SHA-256>`, sem paginação física.
