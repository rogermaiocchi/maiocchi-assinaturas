...
export default function HelpPage() {
  return <LegalPage title="Central de ajuda" lead="Respostas rápidas para concluir sua assinatura com segurança." currentPath="/ajuda/">
    ...
    <h2>Assinatura com certificado ICP-Brasil</h2><p>Quando essa opção estiver indicada, o portal redirecionará ao prestador conectado para seleção do certificado e autorização do titular. Certificado A3 em nuvem dispensa instalação. Token USB exige a ponte local autorizada pelo próprio prestador porque a chave não sai do dispositivo. O Maiocchi Advogado nunca solicita PIN, arquivo A1 ou senha por mensagem, e-mail ou telefone.</p>
