...
export default function SourceCodePage() {
  return <LegalPage title="Código-fonte e licenças" lead="Transparência sobre o motor de assinatura de código aberto utilizado pelo portal." currentPath="/codigo-fonte/">
    <FlowMap eyebrow="Rastreabilidade da versão" title="Do repositório ao ambiente publicado." description="A tag identifica o código correspondente à versão do portal e mantém visíveis origem, licença e modificações." ariaLabel="Fluxo de publicação do código-fonte do portal" steps={[
      ...
      { title: "Versão Maiocchi", description: "A tag reúne portal, adaptações e código correspondente.", icon: Box, tone: "yellow", href: "https://github.com/rogermaiocchi/maiocchi-assinaturas/tree/portal-v1.9.2", linkLabel: "Ver tag" },
      { title: "Artefato", description: "O pacote imutável pode ser baixado diretamente do GitHub.", icon: Download, href: "https://github.com/rogermaiocchi/maiocchi-assinaturas/archive/refs/tags/portal-v1.9.2.zip", linkLabel: "Baixar ZIP" },
    ...
    <p><a className="button button--yellow" href="https://github.com/rogermaiocchi/maiocchi-assinaturas/archive/refs/tags/portal-v1.9.2.zip"><Github aria-hidden="true" size={18} /><span>Baixar código-fonte no GitHub</span><Download aria-hidden="true" size={17} /></a></p>
    <p><a href="https://github.com/rogermaiocchi/maiocchi-assinaturas/tree/portal-v1.9.2" target="_blank" rel="noreferrer">Consultar o repositório e o histórico da versão</a>.</p>
