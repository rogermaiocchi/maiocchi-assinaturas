...
- A folha final apresenta “Evidências da assinatura digital” sem ícone. Todas as páginas recebem linha dourada superior; somente páginas de conteúdo recebem uma faixa lateral direita com a marca `m.` no topo e, abaixo, duas linhas verticais com código, número do documento, SHA-256 da entrada e atestado ML-DSA-65. A última página não recebe essa faixa.
