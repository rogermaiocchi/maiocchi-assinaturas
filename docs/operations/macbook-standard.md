...
- A folha final apresenta “Evidências da assinatura digital” sem ícone. Todas as páginas recebem linha dourada superior de `2,5 pt`; somente páginas de conteúdo recebem uma faixa lateral direita sem divisor, com a marca `m.` centralizada e uma única inscrição vertical contínua, sem quebra: `DOCUMENTO <número> - HASH <SHA-256 da entrada> - CÓDIGO <PQC-MLDSA65> - VERIFICAÇÃO <ID público>`. A última página não recebe essa faixa.
