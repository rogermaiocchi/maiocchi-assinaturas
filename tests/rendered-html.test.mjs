...
test("publica páginas legais e de ajuda", async () => {
  ...
  assert.match(source, /github\.com\/rogermaiocchi\/maiocchi-assinaturas\/archive\/refs\/tags\/portal-v1\.7\.1\.zip/i);
  assert.match(source, /github\.com\/rogermaiocchi\/maiocchi-assinaturas\/tree\/portal-v1\.7\.1/i);
